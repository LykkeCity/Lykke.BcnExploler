...
namespace Lykke.Service.BcnExploler.Web.Models.Offchain
{
    ...
    public class OffchainChannelListViewModel
    {
        ...
        public static OffchainChannelListViewModel Create(IEnumerable<IFilledChannel> channels, IReadOnlyDictionary<string, IAssetDefinition> assetDictionary)
        {
    ...
    public class OffChainTransactionViewModel
    {
        ...
        public static IEnumerable<OffChainTransactionViewModel> Create(IEnumerable<IOffchainTransaction> offchainTransactions, 
            IReadOnlyDictionary<string, IAssetDefinition> assetDictionary)
        {
    ...
    public class OffchainChannelPagedList
    {
        ...
        public static OffchainChannelPagedList Create(long totalCount, int pageSize, Func<IUrlHelper, int, string> buildUrlFunc)
        {
